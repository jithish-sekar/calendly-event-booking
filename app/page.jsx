...
export default function Home() {
  return (
    <main>
      <div className="px-4 pt-14 sm:px-10">
      ...
      {/* second container */}
      <div class="mt-18 bg-gray-50 px-4 sm:px-10 py-12">
        <div class="max-w-7xl mx-auto">
          ...
          <div class="grid lg:grid-cols-3 sm:grid-cols-2 gap-10 mt-14">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-8 fill-blue-600 mb-4 inline-block"
                viewBox="0 0 32 32"
              >
                <path
              ...
              <a
                ...
                class="text-blue-600 font-semibold inline-block mt-2 hover:underline"
              >
                Learn more
              </a>
            </div>
